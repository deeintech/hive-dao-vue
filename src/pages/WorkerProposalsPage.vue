            ...
            <div class="card card-profile border-0 mt-lg-7">
              ...
              <div class="card-body p-3 pt-0 text-center">
                ...
                <span
                  ...
                  ><strong class="mr-5">{{
                    account.reputation ? account.reputation : 25
                  }}</strong>
                  <i class="fas fa-edit mr-1"></i>
                  <strong class="mr-5">{{
                    account.post_count ? account.post_count : 0 | numeric
                  }}</strong
                  ><i class="fas fa-user-friends mr-1"></i
                  ><strong>{{
                    account.followers ? account.followers : 0 | numeric
                  }}</strong></span
                >
              </div>
            </div>
                ...
                <div class="col-lg-4">
                  <div class="pipeline white lined-success">
                    <div class="pipeline-header">
                      ...
                      <div class="pipeline-header-numbers">
                        ...
                        <div class="pipeline-count">
                          {{ totalProposals(`${this.worker}`, "active") }}
                    ...
                    <div class="pipeline-body">
                      <div
                        class="pipeline-item"
                        v-for="proposal in workerProposalsByStatus(
                          `${this.worker}`,
                          'active'
                        )"
                        :key="proposal.id"
                        ...
                        >
                          ...
                          <div class="pi-body">
                            <div class="media align-items-center">
                              <span
                                class="avatar bg-success text-uppercase text-white mr-4"
                          ...
                          <div class="pi-foot pb-0">
                            <span class="extra-info text-wrap">
                              <ul>
                                ...
                                <li>
                                  <strong>{{
                                    proposal.daily_pay | numeric
                                  }}</strong>
                                  SBD / {{ $t("common.day") }}
                                </li>
                                <li>
                                  <strong>{{
                                    proposal.total_requested | numeric
                                  }}</strong>
                                  SBD {{ $t("common.total") }}
                                </li>
                                <li>
                  ...
                  <div class="pipeline white lined-danger">
                    <div class="pipeline-header">
                      ...
                      <div class="pipeline-header-numbers">
                        <div class="pipeline-value"></div>
                        <div class="pipeline-count">
                          {{ totalProposals(`${this.worker}`, "inactive") }}
                          {{ $t("common.proposalsLabel") }}
                        </div>
                      </div>
                      <div class="pipeline-settings">
                      ...
                      >
                        ...
                        >
                          ...
                          <div class="pi-body">
                            <div class="media align-items-center">
                              <span
                                class="avatar bg-danger text-uppercase text-white mr-4"
                                >{{ avatarName(proposal.subject) }}</span
                              >
                            </div>
                            <div class="pi-info">
                  ...
                  <div class="pipeline white lined-warning">
                    <div class="pipeline-header">
                      ...
                      <div class="pipeline-header-numbers">
                        <div class="pipeline-value"></div>
                        <div class="pipeline-count">
                          {{ totalProposals(`${this.worker}`, "expired") }}
                          {{ $t("common.proposalsLabel") }}
                        </div>
                      </div>
                      <div class="pipeline-settings">
                        ...
                        >
                          <div>
                            ...
                            <div class="pi-body">
                              <div class="media align-items-center">
                                <span
                                  class="avatar bg-warning text-uppercase text-white mr-4"
                                  >{{ avatarName(proposal.subject) }}</span
                                >
                              </div>
                              <div class="pi-info">
