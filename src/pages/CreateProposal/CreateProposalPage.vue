          ...
          <b-form @submit.prevent="createProposalKeychain">
            ...
            >
              <b-form-input
                ...
                required
                :placeholder="
                  `${$t('createProposal.dailypayInputPlaceholder')}`
                "
              >
              </b-form-input>
            </b-form-group>
            ...
            >
              <b-form-input
                ...
                required
                :placeholder="
                  `${$t('createProposal.permlinkInputPlaceholder')}`
                "
              >
              </b-form-input>
            </b-form-group>
            ...
            >
              <b-form-input
                ...
                required
                :placeholder="
                  `${$t('createProposal.receiverInputPlaceholder')}`
                "
              >
              </b-form-input>
            </b-form-group>
            <label for="start_date">{{
              $t("createProposal.startdateLabel")
            }}</label>
            <date-picker
              class="mb-3"
              name="start_date"
