...
const router = new Router({
  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          path: "workers",
          component: () =>
            import(/* webpackChunkName: "Workers" */ "./views/Workers.vue")
        },
        {
          path: "createproposal",
          component: () =>
            import(
              /* webpackChunkName: "CreateProposal" */ "./views/CreateProposal.vue"
            )
        }
      ]
    },
    {
      ...
      component: () =>
        import(
          /* webpackChunkName: "WorkerProposals" */ "./views/WorkerProposals.vue"
        )
    },
    {
      path: "*",
