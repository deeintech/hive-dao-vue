            ...
            <div class="col-md-8">
               <b-tabs>
                 <template slot="tabs">
                    ...
                    <b-nav-item><router-link to='/proposals/workers' class="text-dark">{{$t('common.workersLabel')}}</router-link></b-nav-item>
                    <b-nav-item><router-link to='/proposals/createproposal' class="text-dark">{{$t('common.createProposalLabel')}}</router-link></b-nav-item>
                  </template>
                </b-tabs>
            </div>
